...
class Index extends Controller
{
    ...
    public function index(){
        ...
        $this->assign(array('res'=>$res,'count'=>$count,'search'=>$search));
        return $this->fetch('home/index/index');
    }

    public function add(){
        //添加页面
        return $this->fetch('home/index/add');
    }

    public function insert()
    {
        $param = Request::instance()->param();
        $validate = Loader::validate('app\api\validate\home\User');
    ...
    public function edit($id){
        ...
        $this->assign('res',$res);
        return $this->fetch('home/index/edit');
    }
